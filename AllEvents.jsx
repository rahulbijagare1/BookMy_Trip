        ...
        <div className="container-fluid" style={{width:"100%"}}>
            <div className=" bg-white text-white" style={{ backgroundColor:"white" ,width:"auto"}}>
                {/* <div className="card-body"> */}
                    <h3 style={{marginLeft:"609px",color:"black"}}>Our Popular Tour Packages</h3>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        {/* <div className="modal-body vertical-scrollable"> */}
                            <div className="d-flex">
                                ...
                                <div className="ml-5 " style={{overflowY : "scroll",overflowX:"auto ",height:"400px"}}>
                                    ...
                                    <h5 className="px-2">Tour Operator: {item.guideName}</h5>
                        ...
                        <div className="modal-footer">
                            ...
                            <button onClick={e=>addToCart(item)} className="btn btn-warning btn-sm">Book Tour Package</button>
                        </div>
                    </div>
                </div>
            </div>) : ""}
