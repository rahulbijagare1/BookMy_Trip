                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-9">
                            ...
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label font-weight-bold">Tour Package Name</label>
                            ...
                            <button className="btn btn-primary float-right ">Update Tour Package</button>
                            </form>
                        </div>
                    </div>
                </div>
